...
export type 构造二阶类型<构造子, 参数1, 参数2> = 构造子 extends keyof 二阶类型<
  any,
  any
>
  ? 二阶类型<参数1, 参数2>[构造子]
...
export type 取二阶类型构造子<A> = _取二阶类型构造子<
  A,
  联合转元组<keyof 二阶类型<any, any>>
>;
...
export type 取二阶类型参数1<A> = _取二阶类型参数1<
  A,
  联合转元组<keyof 二阶类型<any, any>>
>;
...
export type 取二阶类型参数2<A> = _取二阶类型参数2<
  A,
  联合转元组<keyof 二阶类型<any, any>>
>;
