...
export type 构造五阶类型<构造子, 参数1, 参数2, 参数3, 参数4, 参数5> =
...
export type 取五阶类型构造子<A> = _取五阶类型构造子<
  A,
  联合转元组<keyof 五阶类型<any, any, any, any, any>>
>;
...
export type 取五阶类型参数1<A> = _取五阶类型参数1<
  A,
  联合转元组<keyof 五阶类型<any, any, any, any, any>>
>;
...
export type 取五阶类型参数2<A> = _取五阶类型参数2<
  A,
  联合转元组<keyof 五阶类型<any, any, any, any, any>>
>;
...
export type 取五阶类型参数3<A> = _取五阶类型参数3<
  A,
  联合转元组<keyof 五阶类型<any, any, any, any, any>>
>;
...
export type 取五阶类型参数4<A> = _取五阶类型参数4<
  A,
  联合转元组<keyof 五阶类型<any, any, any, any, any>>
>;
...
export type 取五阶类型参数5<A> = _取五阶类型参数5<
  A,
  联合转元组<keyof 五阶类型<any, any, any, any, any>>
>;
