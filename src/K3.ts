...
export type 构造三阶类型<构造子, 参数1, 参数2, 参数3> =
...
export type 取三阶类型构造子<A> = _取三阶类型构造子<
  A,
  联合转元组<keyof 三阶类型<any, any, any>>
>;
...
export type 取三阶类型参数1<A> = _取三阶类型参数1<
  A,
  联合转元组<keyof 三阶类型<any, any, any>>
>;
...
export type 取三阶类型参数2<A> = _取三阶类型参数2<
  A,
  联合转元组<keyof 三阶类型<any, any, any>>
>;
...
export type 取三阶类型参数3<A> = _取三阶类型参数3<
  A,
  联合转元组<keyof 三阶类型<any, any, any>>
>;
